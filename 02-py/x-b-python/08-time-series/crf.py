...
class CRFTrainer(object):
    ...
    def train(self, X_train, y_train):  # has the shape (n_letters, n_features) # X is a numpy array of samples where each sample
        self.clf.fit(X_train, y_train)

    def evaluate(self, X_test, y_test):
        return self.clf.score(X_test, y_test)

    def classify(self, input_data):  # Run the classifier on input data
