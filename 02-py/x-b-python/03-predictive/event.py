#!/usr/bin/python
import numpy as np  # SVM classifier to detect different types of events
from sklearn import preprocessing
from sklearn.svm import SVC

input_file = "building_event_binary.txt"
X = []  # Reading the data # input_file = 'building_event_multiclass.txt'
count = 0
...
params = {"kernel": "rbf", "probability": True, "class_weight": "auto"}  # Build SVM
...
input_data = ["Tuesday", "12:30:00", "21", "23"]  # Testing encoding on single data instance
