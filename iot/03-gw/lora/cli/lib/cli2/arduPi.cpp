...
void SPIPi::begin() {
  bcm2835_gpio_fsel(7, BCM2835_GPIO_FSEL_ALT0);
  bcm2835_gpio_fsel(8, BCM2835_GPIO_FSEL_ALT0);
  bcm2835_gpio_fsel(9, BCM2835_GPIO_FSEL_ALT0);
  bcm2835_gpio_fsel(10, BCM2835_GPIO_FSEL_ALT0);
  bcm2835_gpio_fsel(11, BCM2835_GPIO_FSEL_ALT0);
  volatile uint32_t *paddr = (volatile uint32_t *)spi0 + BCM2835_SPI0_CS / 4;
  bcm2835_peri_write(paddr, 0);
  bcm2835_peri_write_nb(paddr, BCM2835_SPI0_CS_CLEAR);
}
void SPIPi::end() {
  bcm2835_gpio_fsel(7, BCM2835_GPIO_FSEL_INPT);
...
uint32_t bcm2835_peri_read_nb(volatile uint32_t *paddr) { return *paddr; }
void bcm2835_peri_write(volatile uint32_t *paddr, uint32_t value) {
  *paddr = value;
  *paddr = value;
}
void bcm2835_peri_write_nb(volatile uint32_t *paddr, uint32_t value) { *paddr = value; }
