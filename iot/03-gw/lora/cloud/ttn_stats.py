...
PULL_ACK = 4
PULL_RESP = 3
STAT_PK = {"stat": {"time": "", "lati": 0, "long": 0, "alti": 0, "rxnb": 0, "rxok": 0, "rxfw": 0, "ackr": 100.0, "dwnb": 0, "txnb": 0}}
...
def main(stats_str, gps_str, gwid):
    ...
    try:
        ...
        lati = "undef"
        long = "undef"
    ttn = TTN_stats(id=gwid, lati=lati, long=long, rxnb=rxnb, rxok=rxok, rxfw=rxfw, ackr=ackr, dwnb=dwnb, txnb=txnb, server=SERVER, port=PORT)
    ttn.start()
