...
#define SCK 13
static int REV = 0;
typedef enum { LSBFIRST = 0, MSBFIRST = 1 } bcm2835SPIBitOrder;
typedef enum {
  SPI_MODE0 = 0,
  SPI_MODE1 = 1,
  SPI_MODE2 = 2,
...
typedef enum {
  SPI_CLOCK_DIV65536 = 0,
  SPI_CLOCK_DIV32768 = 32768,
  SPI_CLOCK_DIV16384 = 16384,
  SPI_CLOCK_DIV8192 = 8192,
  SPI_CLOCK_DIV4096 = 4096,
  SPI_CLOCK_DIV2048 = 2048,
  SPI_CLOCK_DIV1024 = 1024,
  SPI_CLOCK_DIV512 = 512,
...
typedef enum { BCM2835_GPIO_FSEL_INPT = 0b000, BCM2835_GPIO_FSEL_OUTP = 0b001, BCM2835_GPIO_FSEL_ALT0 = 0b100, BCM2835_GPIO_FSEL_ALT1 = 0b101, BCM2835_GPIO_FSEL_ALT2 = 0b110, BCM2835_GPIO_FSEL_ALT3 = 0b111, BCM2835_GPIO_FSEL_ALT4 = 0b011, BCM2835_GPIO_FSEL_ALT5 = 0b010, BCM2835_GPIO_FSEL_MASK = 0b111 } bcm2835FunctionSelect;
namespace unistd {
#include <unistd.h>
}
