...
class Age:
    ...
    def get_fuzzy_set(self, age):
        ...
        return [self.young(age), self.middle(age), self.old(age)]
...
class GIM:
    ...
    def get_fuzzy_set(self, gim_value):
        ...
        return [self.very_bad(gim_value), self.bad(gim_value), self.average(gim_value), self.good(gim_value), self.very_good(gim_value), self.excellent(gim_value)]
