...
class Human_Player:
    ...
    def ask_move(self, game):
        ...
        possible_moves_str = list(map(str, game.possible_moves()))  # The str version of every move for comparison with the user input:
        ...
        while True:
            ...
            if move == "show moves":
                ...
                move = possible_moves[int(move[6:]) - 1]  # Fetch the corresponding move and return.
                return move
            elif str(move) in possible_moves_str:
                move = possible_moves[possible_moves_str.index(str(move))]  # Transform the move into its real type (integer, etc. and return).
                return move
