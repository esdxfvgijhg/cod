...
bool parseParameters(int, char **, long int *, double *, double *, double *, double *, double *, double *, double *, double *);
...
int main(int argc, char **argv) {
  ...
  bool test = parseParameters(argc, argv, &var, &prob1, &prob2, &prob3, &prob4, &prob5, &prob6, &prob7, &prob8);
  if (test) {
    int n = (int)var;
...
//
bool parseParameters(int argc, char **argv, long int *var, double *prob1, double *prob2, double *prob3, double *prob4, double *prob5, double *prob6, double *prob7, double *prob8) {
  bool test = true;
  ...
  if (argc == 10) {
    ...
    *prob8 = strtod(argv[9], &endptr9);
    test = ((*var > 0) && (*var < INT_MAX) && (strlen(endptr1) == 0) && (strlen(endptr2) == 0) && (strlen(endptr3) == 0) && (strlen(endptr4) == 0) && (strlen(endptr5) == 0) && (strlen(endptr6) == 0) && (strlen(endptr7) == 0) && (strlen(endptr8) == 0) && (strlen(endptr9) == 0));
  } else {
    test = false;
  }
  return test;
