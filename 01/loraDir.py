...
def checkcollision(packet):
    ...
    if packetsAtBS:
        print(packet.nodeid, packet.sf, packet.bw, packet.freq,
             len(packetsAtBS))
        for other in packetsAtBS:
            if other.nodeid != packet.nodeid:
               print(other.nodeid, other.packet.sf, other.packet.bw, other.packet.freq)
               # simple collision
...
def timingCollision(p1, p2):
    ...
    print(p1.nodeid, env.now - env.now, p1_cs - env.now, p1.rectime,
