...
/* interface __MIDL_itf_Dual_vwstcom_0000_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_Dual_vwstcom_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_Dual_vwstcom_0000_0000_v0_0_s_ifspec;

#ifndef __ISmalltalkCommanderDisp_INTERFACE_DEFINED__
#define __ISmalltalkCommanderDisp_INTERFACE_DEFINED__

/* interface ISmalltalkCommanderDisp */
/* [oleautomation][dual][unique][helpstring][uuid][object] */ 


EXTERN_C const IID IID_ISmalltalkCommanderDisp;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("5FD2D2B3-95A8-11d0-ACAB-E80467000000")
    ISmalltalkCommanderDisp : public IDispatch
    {
    public:
    ...
    typedef struct ISmalltalkCommanderDispVtbl
    {
        BEGIN_INTERFACE
    ...
    interface ISmalltalkCommanderDisp
    {
        CONST_VTBL struct ISmalltalkCommanderDispVtbl *lpVtbl;
    };
...
#define ISmalltalkCommanderDisp_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ISmalltalkCommanderDisp_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ISmalltalkCommanderDisp_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ISmalltalkCommanderDisp_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define ISmalltalkCommanderDisp_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define ISmalltalkCommanderDisp_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define ISmalltalkCommanderDisp_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define ISmalltalkCommanderDisp_Evaluate(This,Expression,retval)	\
    ( (This)->lpVtbl -> Evaluate(This,Expression,retval) ) 

#define ISmalltalkCommanderDisp_EvaluateAsString(This,Expression,retval)	\
    ( (This)->lpVtbl -> EvaluateAsString(This,Expression,retval) ) 

#define ISmalltalkCommanderDisp_Quit(This)	\
    ( (This)->lpVtbl -> Quit(This) ) 

#define ISmalltalkCommanderDisp_GetLastError(This,retval)	\
    ( (This)->lpVtbl -> GetLastError(This,retval) ) 

#define ISmalltalkCommanderDisp_GetLastErrorStack(This,retval)	\
    ( (This)->lpVtbl -> GetLastErrorStack(This,retval) ) 

#define ISmalltalkCommanderDisp_put_AnswerErrors(This,Value)	\
    ( (This)->lpVtbl -> put_AnswerErrors(This,Value) ) 

#define ISmalltalkCommanderDisp_get_AnswerErrors(This,Value)	\
...
#endif 	/* __ISmalltalkCommanderDisp_INTERFACE_DEFINED__ */
