...
typedef struct _vwstcom_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } vwstcom_MIDL_TYPE_FORMAT_STRING;

typedef struct _vwstcom_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } vwstcom_MIDL_PROC_FORMAT_STRING;

typedef struct _vwstcom_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } vwstcom_MIDL_EXPR_FORMAT_STRING;
...
extern const vwstcom_MIDL_TYPE_FORMAT_STRING vwstcom__MIDL_TypeFormatString;
extern const vwstcom_MIDL_PROC_FORMAT_STRING vwstcom__MIDL_ProcFormatString;
extern const vwstcom_MIDL_EXPR_FORMAT_STRING vwstcom__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ISmalltalkCommanderDispVtbl_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ISmalltalkCommanderDispVtbl_ProxyInfo;
...
static const vwstcom_MIDL_PROC_FORMAT_STRING vwstcom__MIDL_ProcFormatString =
    {
        0,
        {
...
static const vwstcom_MIDL_TYPE_FORMAT_STRING vwstcom__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Standard interface: __MIDL_itf_vwstcom_0000_0000, ver. 0.0,
...
/* Object interface: ISmalltalkCommanderDispVtbl, ver. 0.0,
   GUID={0xC9594220,0xF715,0x11d0,{0xA7,0x91,0x00,0xA0,0x24,0xCD,0x45,0xB2}} */

#pragma code_seg(".orpc")
static const unsigned short ISmalltalkCommanderDispVtbl_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ISmalltalkCommanderDispVtbl_ProxyInfo =
    {
    &Object_StubDesc,
    vwstcom__MIDL_ProcFormatString.Format,
    &ISmalltalkCommanderDispVtbl_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ISmalltalkCommanderDispVtbl_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    vwstcom__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(14) _ISmalltalkCommanderDispVtblProxyVtbl = 
{
    &ISmalltalkCommanderDispVtbl_ProxyInfo,
    &IID_ISmalltalkCommanderDispVtbl,
    ...
    (void *) (INT_PTR) -1 /* ISmalltalkCommanderDispVtbl::Evaluate */ ,
    (void *) (INT_PTR) -1 /* ISmalltalkCommanderDispVtbl::EvaluateAsString */ ,
    (void *) (INT_PTR) -1 /* ISmalltalkCommanderDispVtbl::Quit */ ,
    (void *) (INT_PTR) -1 /* ISmalltalkCommanderDispVtbl::GetLastError */ ,
    (void *) (INT_PTR) -1 /* ISmalltalkCommanderDispVtbl::GetLastErrorStack */ ,
    (void *) (INT_PTR) -1 /* ISmalltalkCommanderDispVtbl::put_AnswerErrors */ ,
    (void *) (INT_PTR) -1 /* ISmalltalkCommanderDispVtbl::get_AnswerErrors */
};


static const PRPC_STUB_FUNCTION ISmalltalkCommanderDispVtbl_table[] =
{
...
CInterfaceStubVtbl _ISmalltalkCommanderDispVtblStubVtbl =
{
    &IID_ISmalltalkCommanderDispVtbl,
    &ISmalltalkCommanderDispVtbl_ServerInfo,
    14,
    &ISmalltalkCommanderDispVtbl_table[-3],
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    vwstcom__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _vwstcom_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISmalltalkCommanderDispVtblProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _vwstcom_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISmalltalkCommanderDispVtblStubVtbl,
    0
};

PCInterfaceName const _vwstcom_InterfaceNamesList[] = 
{
    "ISmalltalkCommanderDispVtbl",
    0
};

const IID *  const _vwstcom_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _vwstcom_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _vwstcom, pIID, n)

int __stdcall _vwstcom_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_vwstcom_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo vwstcom_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _vwstcom_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _vwstcom_StubVtblList,
    (const PCInterfaceName * ) & _vwstcom_InterfaceNamesList,
    (const IID ** ) & _vwstcom_BaseIIDList,
    & _vwstcom_IID_Lookup, 
    1,
    2,
